...
class PluginPostProcessorTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        fake_plugin = os.path.join(os.path.dirname(__file__), 'fixtures/fake_plugin.jar')
    ...
    def test_extract_plugin_info(self):
        expected_output = {
            'name': 'MockedPlugin',
            'version': '0.69.420-SNAPSHOT'
        }

        actual_output = self.plugin_post_processor.extract_plugin_info(self.fake_plugin_contents)
